...
function QuestionFilter(props) {
  ...
  useEffect(() => {
    if (currentFilters && currentFilters.hasOwnProperty("level")) {
      ...
      dispatch(
        questionDataActions.setQuestionFilterIds(filteredQuestionIdList)
      );
    }
  ...
  if (currentFilters && currentFilters.hasOwnProperty("level")) {
    if (
      currentFilters &&
      currentFilters.hasOwnProperty("level") &&
      currentFilters.level.length <= 0
    ) {
  ...
  if (currentFilters && currentFilters.hasOwnProperty("topic")) {
  ...
  if (currentFilters && currentFilters.hasOwnProperty("tags")) {
    ...
    <div id="question-filter" className={styles.outerwrap}>
      ...
      <div className={styles["slide-button-wrap"]}>
        ...
        <div className={styles["slide-button-inner-wrap"]}>
          ...
          {currentFilters.hasOwnProperty("topic") &&
        ...
        <div className={styles["slide-button-inner-wrap"]}>
          ...
          {currentFilters.hasOwnProperty("tags") &&
